...
function getVehicleLocationFromVSIM(){
    ...
    var url = 'https://supply.team12.softwareengineeringii.com/api/cs?vehicle-all=1'; //the path needed to get into the database 
    ...
    request.onload = function(){
        ...
        if(request.status >= 200 && request.status < 400){
            ...
            //Vehicle from VSIM
            var vsimLocation_1 = [vehicleLong, vehilceLat]
            var vsimLocation_2 = [vehicleLong_06, vehilceLat_06]
            console.log(vsimLocation_2)
            console.log(vsimLocation_1)
            //Initializing a map and add the vehicle information onto it:
